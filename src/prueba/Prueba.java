...
//java.util.Date fechaUtil = sdf.parse("13/01/01");
//java.sql.Date parametroStarDate = new java.sql.Date(fechaUtil.getTime());
//
//java.util.Date fechasUtil1 = sdf.parse("13/01/05");
//java.sql.Date startDate = new java.sql.Date(fechasUtil1.getTime());
//
//java.util.Date fechaeUtil2 = sdf.parse("24/07/06");
...
//        try {
//            HR hr = new HR();
//            hr.modificarJobHistory(102,parametroStarDate,jh);
//            
//        } catch (ExcepcionHR ex) {
//            
//        }
